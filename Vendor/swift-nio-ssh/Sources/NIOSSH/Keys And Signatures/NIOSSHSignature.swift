...
// Modified by ServerDash in 2026 to backport upstream security commit 31cdc3c
// for GHSA-998x-vgvp-xwpc. See Vendor/SECURITY_PATCHES.md.
...
private struct ECDSASignatureHelper {
    ...
    private init(r: ByteBuffer, s: ByteBuffer, pointSize: Int) throws {
        ...
        // The r and s components are attacker-controlled and parsed before
        // authentication. Values wider than the curve point would otherwise
        // produce a negative offset and write outside this stack storage.
